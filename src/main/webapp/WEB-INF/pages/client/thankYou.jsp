...
<%--            <p>Vào lúc ${donhang.getNgayDatHang()} chúng tôi đã nhận được đơn đặt hàng với những sản phẩm như sau:</p>--%>
            <br>
...
<%--            <br>--%>
            ...
            <p>CMC Shop xin chân thành cảm ơn quý khách hàng đã tin tưởng sử dụng dịch vụ, sản phẩm của chúng tôi</p>
            <br>
            <a href="<%=request.getContextPath()%>/">Nhấn vào đây để tiếp tục mua hàng</a>
        </div>
        <div class="col-md-1">
        </div>
    </div>
