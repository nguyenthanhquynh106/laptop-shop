...
<div class="wrap">
    ...
    <div class="header">
        <br>
        <div class="logo">
            <a href="<%=request.getContextPath()%>/"><img width="350px" src="https://www.cmc.com.vn/main/imgs/logo.svg" title="logo"/></a>
        </div>
        <div class="search-bar">
            <form action="/laptopshop/search">
                <input placeholder="Nhập tên laptop, phụ kiện..." type="text" name="name"><input type="submit" value="Search"/>
            </form>
        </div>
        <div class="clear"></div>
        ...
        <div class="header-top-nav ">
            <c:if test="${pageContext.request.userPrincipal.name != null}">
                ...
                <ul>
                    ...
                    <li><a href="<%=request.getContextPath()%>/cart"><span>Giỏ hàng&nbsp;&nbsp;
					</span></a><span class="glyphicon glyphicon-shopping-cart"></span></li>
    ...
    <div class="wrap">
        ...
        <div class="top-nav">
            <ul>
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Cửa hàng <span
                        class="caret"></span></a>
                    <ul class="dropdown-menu" style="background: #000" id="danhmuc2">
                    </ul>
                </li>
